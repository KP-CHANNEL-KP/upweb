  ...
  return (
    <main className="min-h-screen bg-slate-900 p-6 flex justify-center text-gray-100">
      ...
      <div className="max-w-2xl w-full">
        <h1 className="text-4xl font-bold text-center mb-10 text-emerald-400">Outline free Keys များ Admin မှ ပြန်ပိတ်ထားပါသည်။ဝယ်ယူလိုပါက Viber - 09769043594 သို့ ဆက်သွယ်ပါ။</h1>
